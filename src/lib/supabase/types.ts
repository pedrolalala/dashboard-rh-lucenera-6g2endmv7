      ...
      ferias: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["periodo_aquisitivo_id"]
            isOneToOne: false
            referencedRelation: "vw_controle_ferias_clt"
...
//   observacoes: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   periodo_aquisitivo_id: uuid (nullable)
...
//   data_fim: date (nullable)
//   data_limite_gozo: date (nullable)
//   total_faltas: integer (nullable)
//   dias_direito: integer (nullable)
//   dias_gozados: bigint (nullable)
